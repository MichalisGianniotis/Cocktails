...
export default function HomePage() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-950 to-slate-900 text-white">
      ...
      <div className="px-4">
        {/* Hero Section */}
        <section className="px-6 text-center min-h-[70vh] flex flex-col justify-center">
          <motion.h1
        ...
        <section className="px-6 pb-20 flex flex-col">
          ...
          <div className="grid min-[440px]:grid-cols-2 md:grid-cols-3  gap-6">
            {cocktails.slice(0, 3).map((cocktail) => (
                <Link key={cocktail.id}  href={`/cocktails`} className="scale-100 hover:scale-93 transition-transform">
