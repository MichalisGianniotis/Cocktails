...
export default function CocktailsPage() {
  ...
  return (
      <div className="min-h-screen w-full bg-gradient-to-b from-slate-950 to-slate-900  text-white p-10" role="main">
        <h1 className="text-4xl font-bold text-center mb-8 font-poppins">🍹 Συνταγές Cocktail</h1>
